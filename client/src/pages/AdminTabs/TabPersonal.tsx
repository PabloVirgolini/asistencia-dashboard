...
export function TabPersonal() {
  const {
    sectores, personal, isPersonalLoading, cargosFiltradosPorSector,
    isPersonModalOpen, setIsPersonModalOpen,
    legajo, setLegajo, nombre, setNombre,
    personaSector, setPersonaSector, personaCargo, setPersonaCargo,
    personaEsRotativo, setPersonaEsRotativo, personaEnCapacitacion, setPersonaEnCapacitacion,
    editingPerson, filterText, setFilterText, sortedAndFilteredPersonal,
    handleSort, handleSavePerson, openEditPerson, openAddPerson, handleRemovePerson
  } = useTabPersonal();
