...
### 3.1. Arquitectura Desacoplada (Decoupled Architecture)
...
### 3.2. Sincronización de Datos Inmutable (Delta Sync)
...
### 3.3. Motores Asíncronos (Read Models)
...
### 3.4. Manejo del Tiempo: "Ventanas de Turno" vs "Días Calendario"
...
## 6. Ecosistema de Agentes y Roles
